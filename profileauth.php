...
include 'dbconnect.php';
					...
					else
					{
						...
						$sql5="SELECT * FROM `user_info` WHERE u_id='$u_id' and c_id='$c_id'";
						$result5=mysqli_query($link, $sql5);
						if(mysqli_num_rows($result5) > 0){
						echo "You have taken this course already.";			
						}
						else{
						...
						echo "Course Successfully Inserted.";
							...
							echo "You have already taken maximum course allowed";
...
if($_POST['delete'])
{
						$sql6="DELETE FROM `user_info` WHERE u_id='$u_id';";
    ...
    ?>  
	<form action="profileauth.php" method="post" class="tm-contact-form">
	 <input type="submit" name="delete"  class="btn tm-light-blue-bordered-btn pull-xs-right" value="Delete Courses"/>
	 </form>
                            </div>
