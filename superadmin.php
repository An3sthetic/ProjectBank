            ...
            <nav class="navbar navbar-full navbar-fixed-top bg-inverse">
                ...
                <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                    <ul class="nav navbar-nav">
					    <li class="nav-item">
                            <a href="c_insert.php" class="nav-link external">Insert Course</a>
                        </li>
                        <li class="nav-item">
                            <a href="validate.php" class="nav-link external">Registration request</a>
                        </li>
                        <li class="nav-item">
                            <a href="p_insert.php" class="nav-link external">Insert Project</a>
                        </li>
                        <li class="nav-item">
                            <a href="modify.php" class="nav-link external">Modify Project</a>
                        </li>
                        <li class="nav-item">
